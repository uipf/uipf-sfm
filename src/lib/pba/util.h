...
/////////////////////////////////////////////////////////////////////////////
bool LoadNVM(istream& in, vector<CameraT>& camera_data, vector<Point3D>& point_data,
             vector<Point2D>& measurements, vector<int>& ptidx, vector<int>& camidx,
             vector<string>& names, vector<int>& ptc)
{
...
void SaveNVMs(ostream& out, vector<CameraT>& camera_data, vector<Point3D>& point_data,
             vector<Point2D>& measurements, vector<int>& ptidx, vector<int>& camidx,
             vector<string>& names, vector<int>& ptc)
{
	out << "NVM_V3_R9T\n" << camera_data.size() << '\n' << std::setprecision(12);
             ...
             vector<string>& names, vector<int>& ptc)
{
	...
	SaveNVMs(out, camera_data, point_data, measurements, ptidx, camidx, names, ptc);
}
